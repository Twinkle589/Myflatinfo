            ...
            <View className="bg-[#F3FBFE] p-2">
              ...
              <View className="p-1">
                ...
                <View className="bg-white py-5 w-full">
                    <Text className="text-center text-xl text-[#64A935]">Approved</Text>
                    <TouchableOpacity className="bg-[#64A935] w-[75%] mx-auto  p-3 rounded-md my-5" onPress={() => refRbsheet.current.open()}>
                        <Text className="text-white text-center text-lg">Check IN Time</Text>
                    </TouchableOpacity>
                </View>
          </View>
        </ScrollView>
